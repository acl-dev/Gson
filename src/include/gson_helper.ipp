...
__GSON_DEFINE_ADD_ITEM__(bool, add_array_bool, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(bool*, add_array_bool, *);


__GSON_DEFINE_ADD_ITEM__(int8_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(uint8_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(int16_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(uint16_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(int32_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(uint32_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(int64_t, add_array_number, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(uint64_t, add_array_number, __GSON__NOTHING__);
...
__GSON_DEFINE_ADD_ITEM__(float, add_array_double, __GSON__NOTHING__);
__GSON_DEFINE_ADD_ITEM__(float*, add_array_double, *);
__GSON_DEFINE_ADD_ITEM__(double, add_array_double, __GSON__NOTHING__);
...
__GSON_DEFINE_GET_VALUE__(int16_t, __GSON__NOTHING__);
__GSON_DEFINE_GET_VALUE__(uint16_t, *);
__GSON_DEFINE_GET_VALUE__(uint16_t, __GSON__NOTHING__);

__GSON_DEFINE_GET_VALUE__(int32_t, *);
__GSON_DEFINE_GET_VALUE__(int32_t, __GSON__NOTHING__);
__GSON_DEFINE_GET_VALUE__(uint32_t, *);
__GSON_DEFINE_GET_VALUE__(uint32_t, __GSON__NOTHING__);

__GSON_DEFINE_GET_VALUE__(int64_t, *);
__GSON_DEFINE_GET_VALUE__(int64_t, __GSON__NOTHING__);

__GSON_DEFINE_GET_VALUE__(uint64_t, *);
__GSON_DEFINE_GET_VALUE__(uint64_t, __GSON__NOTHING__);
