...
template<class T>
static inline bool gson(bson_t &bson, const std::list<T> &objs);

template<class T>
static inline bool gson(bson_t &bson, const std::list<T> *objs);

template<class T>
static inline bool gson(bson_t &bson, const std::vector<T> &objs);

template<class T>
static inline bool gson(bson_t &bson, const std::vector<T> *objs);

template<class K, class T>
static inline bool gson(bson_t &bson, const std::map<K, T> &objs);
